# Instagram DM Outreach Strategie
...
```
        ...
        REAGEERT                          REAGEERT NIET
              │                                  │
              ▼                                  ▼
        [ DM 2 sturen ]                  [ Dag 5: Follow-up ]
              │                                  │
        Reageert opnieuw                   Reageert niet
              │                                  │
              ▼                                  ▼
        [ DM 3: Call ]                   [ Dag 11: Afsluiting ]
              │                                  │
        Call ingepland                      Prospect sluiten
```

---

## PAD LINKS — Prospect reageert
...
### DM 2 — Direct na reactie (draft + waarde)
...
### DM 3 — Direct na tweede reactie (call)

> Ze hebben nu twee keer ja gezegd. Nu pas de call vragen.

```
Top!

Zou ik misschien 15 minuten van je tijd mogen lenen?
Dan leg ik je graag meer hierover uit.

Wanneer schikt het volgende week?
```
...
> Na dit geen contact meer. Deur vriendelijk op een kier laten.
...
- **Max 3 DMs per prospect** — altijd, ongeacht het pad
- **Nooit pitchen in DM 1** — eerst nieuwsgierigheid wekken
- **Winkelnaam in elk bericht** — bewijst dat het persoonlijk is
- **Naam altijd goed controleren** — verkeerde naam = direct weg
- **Niet volgen voor de DM** — cold DM werkt, focus op personalisatie
- **Stop na dag 11** — daarna zijn ze niet geïnteresseerd
- **Geen emoji's** — uitzondering: :) in DM1 afsluiting
